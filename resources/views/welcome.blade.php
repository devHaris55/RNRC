        ...
        <iframe src="https://calendar.google.com/calendar/embed?src=haris.dev55%40gmail.com&ctz=Asia%2FKarachi" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
            ...
            <form action="{{ route('U_appointment_schedule') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="first_name" class="form-control" required id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Last Name</label>
                    <input type="text" name="last_name" class="form-control" required id="exampleInputPassword1">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="reason" class="form-control" required id="exampleInputPassword1">
                </div>
